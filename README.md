...
Во время обучения на дому я использовала видеоуроки(множество видеокурсов с youtube), изучала теорию по книгам(Дубовик Е.В., Сергей Тепляков Паттерны проектирования на платформе .NET (2015), и др. ) и сайтам(metanit.com и др.) и проходила онлайн курсы по JS, CSS, HTML, Angular, TypeScript и React. 
