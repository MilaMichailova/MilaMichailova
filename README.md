...
Я начинающий frontend разработчик, JS, CSS, HTML, Angular, Rxjs TypeScript и React.
 ...
 * 🚀  Мой последний [пет проект](https://github.com/MilaMichailova/haosNo), и его [демонстрация](https://milamichailova.github.io/haosNo/) +адаптив
...
| ------------- | ------------- |
|  Последний проект (+адаптив мобильное устройство) |  (https://milamichailova.github.io/haosNo/) |
|  Верстка лендинга по макету (+адаптив мобильное устройство, тв) |  (https://milamichailova.github.io/sf-hw-2/) |
